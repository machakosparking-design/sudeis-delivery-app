 ...
 * Matches the official Falcon Delivery brand mark across all web pages and operations systems.
...
export default function FalconIcon({ 
  ...
  return (
    ...
    >
      ...
      {/* Keen Falcon Eye */}
      <circle cx="18" cy="8" r="0.75" fill={color === 'currentColor' ? 'currentColor' : color} stroke="none" />
    </svg>
  );
}
